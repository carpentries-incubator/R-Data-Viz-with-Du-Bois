...
<figure>
	<div class="row">
	```{r rstudio-analogy, echo=FALSE, fig.show="hold", out.width="100%", fig.alt="Du Bois Style Fanchart"}
knitr::include_graphics("files/fanchart.jpg")
``{r rstudio-analogy, echo=FALSE, fig.show="hold", out.width="100%", fig.alt="Du Bois Style Barchart"}
knitr::include_graphics("files/barchart.jpg")
	</div>
```
</figure>
