...
Edit the code to include an appropriate width size. Below the bar graph uses purple to high Black Americans and the other countries are orange. In the original <b>Plate 47</b>, red is used for Black Americans and darkgreen for the other countries? Update the code.
