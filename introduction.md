...
This episode provides an introduction to using R with R studio. It was created by
the maintainers of the **[R for Social Scientists](https://datacarpentry.org/r-socialsci/)**
Data Carpentries lesson.

Learners can skip this lesson if they are already familiar with R and R studio or plan
to do the coding exercises for this lesson in **Jupyter Lab**.
